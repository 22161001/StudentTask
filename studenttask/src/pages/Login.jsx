...
import { getSession, isAuthenticated, loginUser, loginWithProvider } from '../services/authService';
...
export default function Login() {
  ...
  if (isAuthenticated()) {
    return <Navigate to={getDefaultPrivateRoute(getSession()?.rol)} replace />;
  }
  ...
  const visibleErrorMessage = errorMessage || location.state?.message || '';
