...
const normalizeProfile = (profile) => {
  ...
  return {
    ...
    rol: normalizeRoleLabel(source.rol, DEMO_PROFILE.rol) || DEMO_PROFILE.rol,
  };
};
...
const normalizeSession = (session, profile) => {
  ...
  return {
    ...
    rol: normalizeRoleLabel(session.rol ?? activeProfile.rol, activeProfile.rol) || activeProfile.rol,
